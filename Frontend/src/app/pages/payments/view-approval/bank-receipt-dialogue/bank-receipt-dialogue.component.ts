...
@Component({
  ...
  imports: [MatToolbarModule, MatProgressBarModule, MatPaginatorModule, MatSortModule, MatIconModule, MatProgressSpinnerModule,
    MatDividerModule, RouterModule, MatCardModule, SafePipe, ReactiveFormsModule, MatFormFieldModule, MatInputModule, MatButtonModule],
...
export class BankReceiptDialogueComponent {
  ...
  onDeleteImage(){
    this.fileService.deleteBSUploadByurl(this.imageUrl).subscribe(()=>{
      this.imageUrl = '';
